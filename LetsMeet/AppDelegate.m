...
//            appController.currentLocation = manager.location;
//            appController.user_current_latitude = [[commonUtils getUserDefault:@"currentLatitude" ] doubleValue];
//            appController.user_current_longitude = [[commonUtils getUserDefault:@"currentLongitude" ] doubleValue];
            
            
            //
            //            [commonUtils setUserDefault:@"currentLatitude" withFormat:[NSString stringWithFormat:@"%.8f", 34.06]];
            //            [commonUtils setUserDefault:@"currentLongitude" withFormat:[NSString stringWithFormat:@"%.8f", -84.3]];
            //                        appController.user_current_latitude = [[commonUtils getUserDefault:@"currentLatitude" ] doubleValue];
            //                        appController.user_current_longitude = [[commonUtils getUserDefault:@"currentLongitude" ] doubleValue];
